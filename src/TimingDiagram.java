...
class TimingPaint extends JPanel {
    ...
    private void ALE(int x, int tstate) {
        ...
        if (tstate == 4) {
            g.drawLine(x + 300, y, x + 400, y);
        } else if (tstate == 6) {
            g.drawLine(x + 300, y, x + 600, y);
        }
        g.setColor(Color.white);
    ...
    private void busIdle(int x) {
        ...
        if (io == 1) {
            signalActiveHigh(x, 300, 4, 1);
        } else {
            signalActiveLow(x, 300, 4, 1);
        }
        if (s1 == 1) {
            signalActiveHigh(x, 340, 4, 1);
        } else {
            signalActiveLow(x, 340, 4, 1);
        }
        if (s0 == 1) {
            signalActiveHigh(x, 380, 4, 1);
        } else {
            signalActiveLow(x, 380, 4, 1);
        }
