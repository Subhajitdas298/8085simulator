    ...
    public void parser(String s) {
        ...
        if (s.contains("ORG")) {
            if (s.indexOf("ORG") > -1) {
                ...
                if (temp.equalsIgnoreCase("RST0")) {
                    temp = "0000";
                } else if (temp.equalsIgnoreCase("RST1")) {
                    temp = "0008";
                } else if (temp.equalsIgnoreCase("RST2")) {
                    temp = "0010";
                } else if (temp.equalsIgnoreCase("RST3")) {
                    temp = "0018";
                } else if (temp.equalsIgnoreCase("RST4")) {
                    temp = "0020";
                } else if (temp.equalsIgnoreCase("RST5")) {
                    temp = "0028";
                } else if (temp.equalsIgnoreCase("RST6")) {
                    temp = "0030";
                } else if (temp.equalsIgnoreCase("RST7")) {
                    temp = "0038";
                } else if (temp.equalsIgnoreCase("RST5.5")) {
                    temp = "002C";
                } else if (temp.equalsIgnoreCase("RST6.5")) {
                    temp = "0034";
                } else if (temp.equalsIgnoreCase("RST7.5")) {
                    temp = "003C";
                }
